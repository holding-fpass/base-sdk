...
export enum MeasurementType {
  ...
  COURSE_REACTION_COUNT_1 = "course.reaction.count.1",
  COURSE_REACTION_COUNT_2 = "course.reaction.count.2",
  COURSE_REACTION_COUNT_3 = "course.reaction.count.3",
  COURSE_REACTION_COUNT_4 = "course.reaction.count.4",
  COURSE_REACTION_COUNT_5 = "course.reaction.count.5",
  // Content
  CONTENT_CLICK = "content.click",
  CONTENT_OPEN = "content.open",
  CONTENT_VIEW = "content.view",
  CONTENT_REACTION_COUNT = "content.reaction.count",
  CONTENT_REACTION_COUNT_1 = "content.reaction.count.1",
  CONTENT_REACTION_COUNT_2 = "content.reaction.count.2",
  CONTENT_REACTION_COUNT_3 = "content.reaction.count.3",
  CONTENT_REACTION_COUNT_4 = "content.reaction.count.4",
  CONTENT_REACTION_COUNT_5 = "content.reaction.count.5",
  // Response
